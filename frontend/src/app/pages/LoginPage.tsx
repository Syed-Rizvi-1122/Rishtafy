        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-sm border p-8" style={{ borderColor: 'var(--color-neutral-100)' }}>
            ...
            <button
              ...
              className="w-full py-3 rounded-xl border border-neutral-100 flex items-center justify-center gap-3 text-sm font-medium transition-all hover:bg-neutral-50"
